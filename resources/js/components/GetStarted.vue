<template>
    <div>
        ...
        <v-dialog v-model="dialog" :fullscreen="true" :persistent="true">
            <v-card>
                <v-card-title class="headline grey lighten-2" primary-title>Get Started</v-card-title>
                    ...
                    <v-stepper v-model="e1">
                        <v-stepper-header>
                            <v-stepper-step :complete="e1 > 1" step="1">
                                Your Warehouse
                                <small>Define your warehouse(s). Just click "New Item" button.</small>
                            </v-stepper-step>
            ...
            if (step == 2) {
                ...
                axios.get("/storages/get").then(response => {
                    ...
                    if (!storages.length) {
                        ...
                        this.snackBarTxt =
                            "You must add warehouse and storage first.";
                        this.e1 = 1;
                    }
                });
            } else if (step == 4) {
