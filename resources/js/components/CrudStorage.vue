<template>
    <div>
        ...
        >
                                    ...
                                    <v-container>
                                        <v-row>
                                            ...
                                            >
                                                ...
                                                <search-warehouse
                                                    v-if="editedIndex !== -1"
                                                    @selectedItem="updateSelWarehouse"
                                                    :defaultValue="form['warehouse_id']"
                                                    :errorMessage="form.errors.get('warehouse_id')"
                                                ></search-warehouse>
                                                <v-switch 
            ...
            <template v-slot:item.warehouse_id="{ item }">{{item.warehouse.name}}</template>
...
export default {
    ...
    methods: {
        ...
        toggleItem(item) {
            this.editedIndex = this.items.indexOf(item);
            this.form = new Form(Object.assign({}, item));
            this.form.put("storages/" + this.form.id).then(response => {
        ...
        save() {
            if (this.editedIndex > -1) {
                ...
                this.form.post("/storages").then(response => {
