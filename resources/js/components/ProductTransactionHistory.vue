<template>
    <div>
        ...
        >
            ...
            <template v-slot:item.transaction_type="{ item }">{{item.transaction.transaction_type}}</template>
            ...
            <template v-slot:item.processed_by="{ item }">{{item.transaction.processed_by.name}}</template>
        </v-data-table>
    </div>
</template>
