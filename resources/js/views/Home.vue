                ...
                <v-col cols="12" md="4">
                    <v-card color="rgb(251, 140, 0)">
                        ...
                        <v-card-actions>
                            <v-btn-toggle>
                                <router-link
                                    :to="{ name: 'transactions', params: { transaction_type: 'in', warehouse_id: warehouse.value, status: 5 }}"
                                    tag="v-btn"
                ...
                <v-col cols="12" md="4">
                    <v-card color="rgb(76, 175, 80)">
                        ...
                        <v-card-actions>
                            <v-btn-toggle>
                                <router-link
                                    :to="{ name: 'transactions', params: { transaction_type: 'out', warehouse_id: warehouse.value, status: 5 }}"
                                    tag="v-btn"
                ...
                <v-col cols="12" md="4">
                    <v-card color="rgb(0, 202, 227)">
                        ...
                        <v-card-actions>
                            <v-btn-toggle>
                                <router-link
                                    :to="{ name: 'transactions', params: { transaction_type: 'transfer', warehouse_id: warehouse.value, status: 5 }}"
                                    tag="v-btn"
                                >{{getTransaction(warehouse.value, 'transfer')}}</router-link>
                                <router-link
                                    :to="{ name: 'transactions', params: { transaction_type: 'transfer', warehouse_id: warehouse.value, status: 5 }}"
                                    tag="v-btn"
                                >
