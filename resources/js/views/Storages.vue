  ...
  <div class="">
          ...
          <td>
            <b-button-group v-if="storage === hoverSelectedItem">
              <b-button
                ...
                @click="editItem(storage.id)"
                size="sm"
                >Edit</b-button
              >
              <b-button @click="deleteItem(storage.id)" size="sm"
                >Delete</b-button
              >
            </b-button-group>
    ...
    <b-modal id="add-modal" title="Add Record" :hide-footer="true">
      <crud-form
        ...
        :fields="fields"
        :fieldsInit="{ name: '', warehouse_id: null, enabled: 1 }"
      ></crud-form>
    </b-modal>
    <b-modal id="edit-modal" title="Edit Record" :hide-footer="true">
      <crud-form
        ...
        :modelName="this.$options.name"
        :fields="fields"
        :fieldsInit="{ name: '', warehouse_id: null, enabled: '' }"
      ></crud-form>
    </b-modal>
    <b-pagination
      v-model="currentPage"
